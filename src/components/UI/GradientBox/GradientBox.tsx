...
export default function GradientBox({ decor, children }: IGradientBoxProps) {
    return (
        <section className="relative -z-1 w-full rounded-lg mt-10 px-10 py-10 md:py-14 text-headerColor bg-gradient-to-r from-gradientMainFirst to-gradientMainSecond md:px-20 ">
            {children}
            <Image
                src={boxDecor}
                alt='decor'
